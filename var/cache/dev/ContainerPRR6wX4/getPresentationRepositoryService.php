...
// Returns the private 'App\Repository\PresentationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PresentationRepository.php';

return $this->privates['App\\Repository\\PresentationRepository'] = new \App\Repository\PresentationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
