...
class __TwigTemplate_3884df2a42a069c70fe28c386107b309189dbc04dc093d74bc6ac1dd03fd353b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<?php echo \$view['form']->block(\$form, 'form_widget_simple', ['type' => isset(\$type) ? \$type : 'text']).\$view->escape(\$symbol) ?>
", "@Framework/Form/percent_widget.html.php", "C:\\wamp64\\www\\RSMproject\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\percent_widget.html.php");
    }
}
