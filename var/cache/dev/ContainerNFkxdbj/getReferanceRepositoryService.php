...
// Returns the private 'App\Repository\ReferanceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ReferanceRepository.php';

return $this->privates['App\\Repository\\ReferanceRepository'] = new \App\Repository\ReferanceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
